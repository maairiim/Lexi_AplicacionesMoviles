...
import kotlinx.android.synthetic.main.activity_tema_pregunta_video_musica.*

class TemaPreguntaVideoMusicaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tema_pregunta_video_musica)
        ...
        musicabuttontextopregunta.setOnClickListener {
            var intent: Intent = Intent(this, TemaPreguntaLecturaMusicaActivity::class.java)

...
import kotlinx.android.synthetic.main.activity_tema_pregunta_video_tradiciones.*

class TemaPreguntaVideoTradicionesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tema_pregunta_video_tradiciones)
        ...
        tradicionesbuttontextopregunta.setOnClickListener {
            var intent: Intent = Intent(this, TemaPreguntaLecturaTradicionesActivity::class.java)

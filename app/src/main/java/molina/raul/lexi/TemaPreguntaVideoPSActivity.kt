...
import kotlinx.android.synthetic.main.activity_tema_pregunta_video_psactivity.*

class TemaPreguntaVideoPSActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tema_pregunta_video_psactivity)
        ...
        psbuttontextopregunta.setOnClickListener {
            var intent: Intent = Intent(this, TemaPreguntaLecturaPSActivity::class.java)

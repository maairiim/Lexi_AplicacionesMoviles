...
import kotlinx.android.synthetic.main.activity_tema_pregunta_video_historia.*

class TemaPreguntaVideoHistoriaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tema_pregunta_video_historia)
        ...
        historiabuttontextopregunta.setOnClickListener {
            var intent: Intent = Intent(this, TemaPreguntaLecturaHistoriaActivity::class.java)
